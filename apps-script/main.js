 ...
 * Combined menu for both GB Energy and GB Live Dashboard features.
 */
function onOpen() {
  const ui = SpreadsheetApp.getUi();
  
  // GB Energy Menu (existing features)
  ...
  // GB Live Dashboard Menu (new executive dashboard)
  ui.createMenu('⚡ GB Live Dashboard')
      .addItem('🔄 Refresh Data', 'refreshGBLiveData')
      .addItem('✨ Rebuild Layout', 'buildGBLiveLayout')
      .addSeparator()
      .addItem('🎨 Toggle Theme (Light/Dark)', 'toggleTheme')
      .addToUi();
}
