...
function onOpen() {
  ...
  // Live Outages menu (merged from Code.js)
  ui.createMenu('⚠️ Live Outages')
    .addItem('Refresh Data', 'refresh_all_outages')
    .addToUi();
  
  // TEST: Show notification that package version is loaded
  SpreadsheetApp.getActiveSpreadsheet().toast(
    '✅ Upower Dashboard V2 Loaded - All Menus Active!', 
...
function showAbout() {
  ...
  message += 'Package Version: 1.0\n';
  message += 'Created: November 2025';
  ui.alert('About', message, ui.ButtonSet.OK);
}

// ============================================================================
// LIVE OUTAGES FUNCTION (Merged from Code.js)
// ============================================================================
