...
# ----- Authentication -----
# Scopes for Google Sheets and Apps Script
SCOPES = [
...
try:
    ...
    print(
        "Please ensure the spreadsheet exists and the service account has access to it"
    )
    exit(1)

# ----- Step 2: Prepare GeoJSON data for embedding -----
try:
    ...
    # Remove indentation to save space
...
try:
    ...
    print("Please ensure the service account has write access to the spreadsheet")
    exit(1)
...
try:
    ...
    print("Creating standalone Apps Script project as fallback...")
    try:
        ...
        print("NOTE: You'll need to manually connect this script to your spreadsheet.")
    except Exception as e2:
        print(f"Error creating standalone Apps Script project: {e2}")
        print("Please create the Apps Script project manually using the code below.")
        script_id = "MANUAL_SETUP_REQUIRED"

# ----- Step 6: Prepare Apps Script code -----
...
# ----- Step 7: Upload Apps Script code -----
if script_id != "MANUAL_SETUP_REQUIRED":
    try:
        ...
        print("Please set up the Apps Script manually using the code generated below")
        script_id = "MANUAL_SETUP_REQUIRED"

# ----- Step 8: Generate manual setup files if needed -----
if script_id == "MANUAL_SETUP_REQUIRED":
    print("\nGenerating files for manual setup...")

    # Create a directory for the manual setup files
    manual_dir = "dno_map_manual_setup"
...
print(
    "\nIMPORTANT: This implementation embeds the GeoJSON directly in the Apps Script code,"
)
print("eliminating the need for separate GeoJSON file storage in Google Drive.")
