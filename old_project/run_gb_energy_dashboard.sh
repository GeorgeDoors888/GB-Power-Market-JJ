#!/bin/bash
# Run the GB Energy Dashboard
# Enhanced version with improved visualizations and UI
...
streamlit run "/Users/georgemajor/Jibber Jabber ChatGPT/8_august_jibber_jabber/gb_energy_dashboard.py" \
  --server.port=8505 \
