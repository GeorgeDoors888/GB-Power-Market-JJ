"""
Automated GB Power Map Generator for AlmaLinux UpCloud Server
...
def load_dno_geojson():
    ...
    geojson_path = "/var/www/maps/data/dno_regions.geojson"
...
def main():
    ...
    try:
        ...
        output_path = "/var/www/maps/gb_power_complete_map.html"
