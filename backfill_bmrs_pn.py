#!/usr/bin/env python3
"""
Backfill bmrs_pn (Physical Notifications) - 51 days behind
Gap: Oct 29 - Dec 18, 2025 (51 days)
Endpoint: /datasets/PN/stream (NOT /datasets/PN)
"""
...
ENDPOINT = "/datasets/PN/stream"  # CRITICAL: Use /stream not /datasets/PN

def fetch_pn_data(from_date, to_date):
    """
    Fetch PN data for date range

    Args:
        from_date: datetime object
        to_date: datetime object

    Note: PN requires /stream endpoint and uses 'from'/'to' parameters (not publishDateTime)
    """
...
def backfill_range(start_date, end_date):
    """
    Backfill PN data in 7-day chunks
    ...
    while current < end_date:
        ...
        records = fetch_pn_data(current, chunk_end)
...
if __name__ == "__main__":
    print("=" * 60)
    print("BMRS PN Backfill - Stream Endpoint")
    print("=" * 60)
