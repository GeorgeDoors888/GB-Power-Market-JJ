...
echo "🔧 BESS Apps Script - Redeployment to Correct Sheet"
echo "===================================================="
echo ""
echo "✅ FIXED: Code.gs now references correct sheet (12jY0d4j...)"
echo ""
echo "📋 Current Status:"
echo "   ❌ Apps Script deployed to WRONG sheet (1LmMq4OE... V2 sheet)"
echo "   ✅ Python pipeline updates CORRECT sheet (12jY0d4j... Main sheet)"
echo "   ✅ Code files now fixed with correct sheet ID"
echo ""
echo "🎯 NEXT STEPS:"
echo ""
echo "═══════════════════════════════════════════════════════════"
...
echo "      • Look at browser URL bar"
echo "      • Copy the long ID after '/d/' and before '/edit'"
echo "      • Example: https://script.google.com/...d/SCRIPT_ID_HERE/edit"
echo "      • Save this Script ID"
echo ""
echo "   Option B - If NO script or OLD script:"
echo "      • Delete old code (if any)"
echo "      • Leave editor open"
echo "      • Continue to Step 2"
echo ""
echo "═══════════════════════════════════════════════════════════"
...
echo "7. Look for '⚡ GB Energy Dashboard' menu"
echo ""
...
echo ""
echo "3. Check for menu: '⚡ GB Energy Dashboard'"
echo ""
echo "4. Go to BESS sheet"
echo ""
echo "5. Verify existing data INTACT:"
echo "   ✅ Rows 1-14: DNO Lookup (postcode/MPAN)"
echo "   ✅ Rows 15-20: HH Profile (500/1000/1500 kW)"
echo "   ✅ Rows 27-50: BtM PPA Analysis"
echo ""
echo "6. Test formatting:"
echo "   • Click menu → '🎨 Format BESS Enhanced'"
echo "   • Check rows 58-60 formatted correctly"
echo "   • Check KPIs panel (T60:U67) orange/yellow"
echo "   • Check Revenue stack (W60:Y67) orange/yellow"
echo ""
echo "═══════════════════════════════════════════════════════════"
...
echo ""
echo "📄 Files Fixed:"
echo "   ✅ apps_script_enhanced/bess_integration.gs (line 7)"
echo "   ✅ apps_script_deploy/Code.gs (line 7)"
echo ""
echo "📊 Sheet IDs:"
echo "   ❌ OLD (V2):  1LmMq4OEE639Y-XXpOJ3xnvpAmHB6vUovh5g6gaU_vzc"
echo "   ✅ NEW (Main): 1-u794iGngn5_Ql_XocKSwvHSKWABWO0bVsudkUJAFqA"
echo ""
echo "📖 Full diagnostic: DIAGNOSTIC_REPORT.md"
echo ""
