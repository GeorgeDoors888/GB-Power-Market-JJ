...
print("=" * 80)
print("🔧 SETUP: GOOGLE SHEETS REFRESH MENU")
print("=" * 80)
print()
...
print()
print("6. Click the Save icon (💾) or press Cmd+S / Ctrl+S")
print()
...
print()
print("10. You should now see a new menu: '⚡ Power Market'")
print()
print("=" * 80)
...
print()
print("💡 TIP: Use screen or tmux to keep it running:")
print()
...
print("1. Open your Google Sheet")
print()
print("2. Click the menu: ⚡ Power Market > 🔄 Refresh Data Now")
print()
print("3. You'll see a dialog: 'Refresh Requested'")
print()
print("4. Cell L5 will show: ⏳ Refreshing...")
print()
print("5. Watch the watcher terminal - you'll see it detect the request")
print("   and run the update script")
print()
print("6. After 30-60 seconds, cell L5 will show: ✅ Up to date")
print()
...
print()
print("Q: Status stays on '⏳ Refreshing...' forever")
