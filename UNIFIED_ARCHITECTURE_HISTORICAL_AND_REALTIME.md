...
|-----------|----------|--------|---------|
| `ingest_elexon_fixed.py` | ~/repo/GB Power Market JJ | ✅ | Batch download from Elexon API |
| `fetch_fuelinst_today.py` | ~/repo/GB Power Market JJ | ✅ | Today's FUELINST data |
| `update_graph_data.py` | ~/repo/GB Power Market JJ | ✅ | Dashboard updater (historical) |
...
| Component | Location | Status | Purpose |
|-----------|----------|--------|---------|
| IRIS Client | ~/repo/GB Power Market JJ/iris-clients/python | 🟢 PID 81929 | Download messages from Azure |
| IRIS Processor | ~/repo/GB Power Market JJ | 🟢 PID 15141 | Upload to BigQuery + auto-delete |
| Overnight Monitor | ~/repo/GB Power Market JJ | 🟢 PID 6334 | Health checks every 5 min |
| `automated_iris_dashboard.py` | ~/repo/GB Power Market JJ | ✅ | Dashboard updater (real-time) |
...
- **[AUTHENTICATION_AND_CREDENTIALS_GUIDE.md](../repo/GB%20Power%20Market%20JJ/AUTHENTICATION_AND_CREDENTIALS_GUIDE.md)** - How authentication works
- **[IRIS_AUTOMATED_DASHBOARD_STATUS.md](../repo/GB%20Power%20Market%20JJ/IRIS_AUTOMATED_DASHBOARD_STATUS.md)** - IRIS deployment status
